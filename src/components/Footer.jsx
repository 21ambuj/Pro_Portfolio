...
export default function Footer() {
  const socialLinks = [
    { icon: <Github size={20} />, href: "https://github.com/21ambuj", label: "GitHub" },
    { icon: <Linkedin size={20} />, href: "https://linkedin.com/in/ambuj-kumar-maurya", label: "LinkedIn" },
    { icon: <Mail size={20} />, href: "mailto:ambuj20maurya@gmail.com", label: "Email" },
